...
foreach($clubsApplied as $item) {
	...
	echo $club_name . "</p></a></td><td width=20%><p>" . $clubStates[$club_id] . "</p></td><td width=20%><p>" . $clubStart[$item[0]] . "</p></td><td width=20%><p>" . $clubClose[$item[0]] . "</p></td><td width=20%><p><a href=\"submit.php?app_id=" . $item[3] . "&club_id=" . $item[0] . "\">SUBMIT</a></p>";
	echo "</td></tr>";
}
?>
</table>