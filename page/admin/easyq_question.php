...
<p>Question name: <input type="text" name="name" /> (not shown for text questions)</p>
...
<? if($type == "select") { ?>
	...
	<input type="radio" name="method" value="single" /> Single selection (radio button, like this)<br />
