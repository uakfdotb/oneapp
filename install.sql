...
CREATE TABLE users (id INT PRIMARY KEY AUTO_INCREMENT, username VARCHAR(64), password VARCHAR(128), email VARCHAR(256), register_time INT, accessed INT, firstname VARCHAR(256), lastname VARCHAR(256));
