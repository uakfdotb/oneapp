CREATE TABLE baseapp (id INT PRIMARY KEY AUTO_INCREMENT, category INT, orderId INT, varname TEXT, vardesc TEXT, vartype TEXT);
...
CREATE TABLE supplements (id INT PRIMARY KEY AUTO_INCREMENT, club_id INT, orderId INT, varname TEXT, vardesc TEXT, vartype TEXT);
