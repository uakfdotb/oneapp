...
CREATE TABLE admins (id INT PRIMARY KEY AUTO_INCREMENT, club_id INT, username VARCHAR(64), password VARCHAR(128), email VARCHAR(256), box_enabled INT, cat_enabled INT);
...
CREATE TABLE club_notes (application_id INT, club_id INT, box TEXT, category VARCHAR(16), rank INT);
